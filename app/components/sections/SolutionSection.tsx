...
import { QuestionLink } from '../features/QuestionLink';
    ...
    <div className="flex flex-col items-center gap-y-2 px-4 py-12 pb-10">
      ...
      <div className="mt-12 w-full">
        <div className="relative mb-6 text-center">
          <div className="whitespace-nowrap text-center text-base font-semibold leading-[25.6px] tracking-normal">
            なぜ持ち家にする人が多い？
          </div>
          <img
        ...
        <YellowCard
          ...
          contentText={
            <>
              <p className="mb-3 text-lg leading-[18px] tracking-normal">生涯にかかる出費が</p>
              <div>
