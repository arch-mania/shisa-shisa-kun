    ...
    <section id="solution">
      <div className="flex flex-col items-center gap-y-2 px-4 py-12 pb-10">
        ...
        <div className="relative w-full text-center">
          <p className="tracking-normal text-center text-[32px] font-bold leading-[44.8px] text-text">
        ...
        <div className="mt-12 w-full">
          <div className="relative mb-6 text-center">
            <div className="tracking-normal whitespace-nowrap text-center text-base font-semibold leading-[25.6px]">
              なぜ持ち家にする人が多い？
            </div>
            <img
          ...
          <YellowCard
            ...
            contentText={
              <>
                <p className="tracking-normal mb-3 text-lg leading-[18px]">生涯にかかる出費が</p>
                <div>
                  <p className="tracking-normal text-2xl font-bold leading-[140%]">
                    賃貸よりも
                    <br />
