...
const ThoughtBubbleItem = ({ thought }: ThoughtBubbleProps): JSX.Element => (
  <div className="flex items-center gap-x-4">
    ...
    <div>
      <p className="tracking-normal text-sm leading-[150%]">
        {thought.text}
        <br />
        <span className="tracking-normal text-xl font-bold leading-[150%]">
    ...
    <section id="problem" className="w-full bg-[#eeeeee] px-3 py-12">
      <div className="flex flex-col items-center gap-y-10">
        <div className="space-y-8">
          <h2 className="tracking-normal text-center text-xl font-bold leading-[160%]">
            買う？借りる？
            <br />
            その前に、まず住まいのことを
            <br />
        ...
        <div className="space-y-4 text-center">
          <p className="tracking-normal text-lg font-bold leading-[160%]">
            決める前に、知ってほしい。
            <br />
